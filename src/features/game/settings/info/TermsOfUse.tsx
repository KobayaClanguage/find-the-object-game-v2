    ...
    <div className="min-h-screen bg-gray-50">
      <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-lg bg-white p-6 shadow-sm md:p-10">
          <h1 className="mb-8 text-center font-bold text-2xl text-gray-900 sm:text-3xl">
            「オブジェを探せゲーム」
            <br />
            利用規約
          </h1>
          ...
          <section className="mb-10">
            <h2 className="mt-8 mb-4 border-gray-200 border-b pb-2 font-bold text-gray-800 text-xl sm:text-2xl">
              第1章 総則
            </h2>
            <h3 className="mt-6 mb-3 font-semibold text-gray-800 text-lg">
              第1条（本規約への同意）
            </h3>
          ...
          <section className="mb-10">
            ...
            <ul className="list-inside list-disc space-y-1 pl-4 text-gray-700 leading-relaxed">
              <li>エリア内のマップ表示機能</li>
            ...
            <ul className="list-inside list-disc space-y-2 pl-4 text-gray-700 leading-relaxed">
          ...
          <section className="mb-10">
            ...
            <ul className="mb-4 list-inside list-disc space-y-2 pl-4 text-gray-700 leading-relaxed">
              <li>
