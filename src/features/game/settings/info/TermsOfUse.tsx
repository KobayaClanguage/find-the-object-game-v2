      ...
      <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-lg bg-white p-6 shadow-sm md:p-10">
          ...
          <section className="mb-10">
            <h2 className="mb-4 mt-8 border-b border-gray-200 pb-2 text-xl font-bold text-gray-800 sm:text-2xl">
              第1章 総則
            </h2>
          ...
          <section className="mb-10">
            ...
            <ul className="list-inside list-disc space-y-1 pl-4 leading-relaxed text-gray-700">
              <li>エリア内のマップ表示機能</li>
            ...
            <ul className="list-inside list-disc space-y-2 pl-4 leading-relaxed text-gray-700">
          ...
          <section className="mb-10">
            ...
            <ul className="mb-4 list-inside list-disc space-y-2 pl-4 leading-relaxed text-gray-700">
              <li>
